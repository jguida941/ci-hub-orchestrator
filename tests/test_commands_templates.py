...
class TestSyncTemplatesRepoNotFound:
    ...
    def test_repo_not_found_returns_error(
        ...
        with mock.patch(
            ...
            mock_get_entries.return_value = [
                {"full": "owner/existing", "language": "python"}
            ]
...
class TestSyncTemplatesRenderError:
    ...
    def test_render_error_continues(
        ...
        with mock.patch(
            ...
            with mock.patch(
                "cihub.commands.templates.render_dispatch_workflow"
            ) as mock_render:
...
class TestSyncTemplatesUpToDate:
    ...
    def test_up_to_date_returns_success(
        self, base_args: argparse.Namespace, capsys
    ) -> None:
...
class TestSyncTemplatesCheckMode:
    ...
    def test_check_mode_out_of_date_fails(
        self, base_args: argparse.Namespace, capsys
    ) -> None:
    ...
    def test_check_mode_stale_workflow_fails(
        self, base_args: argparse.Namespace, capsys
    ) -> None:
        ...
        with mock.patch(
            ...
            with mock.patch(
                ...
                with mock.patch(
                    ...
                    with mock.patch(
                        "cihub.commands.templates.delete_remote_file"
                    ) as mock_delete:
                        result = cmd_sync_templates(base_args)
                        assert result == 0
                        captured = capsys.readouterr()
...
class TestSyncTemplatesTagUpdate:
    ...
    def test_tag_update_requires_confirmation(
