...
usage: cihub [-h] [--version]
             {detect,preflight,doctor,scaffold,smoke,check,ci,run,report,docs,config-outputs,hub-ci,new,init,update,validate,setup-secrets,setup-nvd,fix-pom,fix-deps,sync-templates,config}
             ...
