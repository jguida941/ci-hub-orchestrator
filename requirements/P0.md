...
### 3.1 Core Docs
- [x] `docs/ONBOARDING.md` exists
- [x] `docs/RESEARCH.md` comprehensive (1700+ lines)
- [x] `docs/ROADMAP.md` with phases
- [x] `AGENTS.md` for AI context
- [x] `requirements/` folder with checklists
- [~] `docs/WORKFLOWS.md` - each workflow documented (needs verification)
- [~] `docs/CONFIG_REFERENCE.md` - field-by-field (filled; needs verification)
- [~] `docs/TOOLS.md` - each tool documented (filled; needs verification)
- [~] `docs/MODES.md` - central vs distributed explained (expanded; needs verification)
